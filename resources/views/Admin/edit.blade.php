     ...
     <form action="{{route('users.update',[$user->id])}}" method="post" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="username" class="form-control col-md-12 col-xs-12" name="username" placeholder="Enter subject name" required="required" type="text"value="{{old('username',$user->username)}}">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="password" class="form-control col-md-12 col-xs-12" name="password" placeholder="password" required="required" type="text"value="{{old('password',$user->password)}}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="email" class="form-control col-md-12 col-xs-12" name="email" placeholder="email" required="required" type="text"value="{{old('email',$user->email)}}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="firstname" class="form-control col-md-12 col-xs-12" name="firstname" placeholder="firstname" required="required" type="text"value="{{old('firstname',$user->firstname)}}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="surname" class="form-control col-md-12 col-xs-12" name="surname" placeholder="surname" required="required" type="text"value="{{old('surname',$user->surname)}}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="city" class="form-control col-md-12 col-xs-12" name="city" placeholder="city" required="required" type="text"value="{{old('city',$user->city)}}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <input id="country" class="form-control col-md-12 col-xs-12" name="country" placeholder="country" required="required" type="text"value="{{old('country',$user->country)}}">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payment">Payment <span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <form action method="Put">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="checkbox">
                                    <label>
                                        <td><input type="checkbox" checked="" name=""     
                                             value>Payment </td>
