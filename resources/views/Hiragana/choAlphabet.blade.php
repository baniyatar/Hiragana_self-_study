...
<body>
  <div class="box">
    ...
    <p style="font-size: 50px;">ほう<span style="color: red;">ちょ</span>う　Kitchen knife
      <audio id="audio1"> 
        <source src="hiragana/cho/ほうちょう.mp3" type="audio/mp3">
      </audio>
  ...
  <button class="prev_btn" onclick="location.href='{{ url('/chuAlphabet')}}'">&lt;PREV</button>
  <button class="next_btn" onClick="location.href='{{ url('/nyaAlphabet')}}'">NEXT&gt;</button>
</body>
