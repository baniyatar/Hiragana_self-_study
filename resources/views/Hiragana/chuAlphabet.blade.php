...
<body>
  <div class="box">
    ...
    <p style="font-size: 50px;"><span style="color: red;">ちゅ</span>うしゃ　Injection
      <audio id="audio2">
        <source src="hiragana/chu/ちゅうしゃ.mp3" type="audio/mp3">
      </audio>
  ...
  <button class="prev_btn" onclick="location.href='{{ url('/chaAlphabet')}}'">&lt;PREV</button>
  <button class="next_btn" onClick="location.href='{{ url('/choAlphabet')}}'">NEXT&gt;</button>
</body>
