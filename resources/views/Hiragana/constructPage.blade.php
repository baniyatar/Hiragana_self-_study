...
<body>
	<div class="box">
        ...
        <p>Similarly, "さ(Sa) line", "た(Ta) line", " な (Na) line", "は (Ha) line", and "ま(Ma) line" are make one "Hiragana" with a pair of a consonent and a vowel.  However, "し (Shi)" of "さ (Sa) line" and "ち(Chi)" and "つ(Tsu)" of "た (Ta) line" are not consonants + vowels, but two consonants. In addition, "や(Ya) line" and "わ (Wa) line" have blanks, and there is no corresponding "Hiragana"</p>
        <br>
