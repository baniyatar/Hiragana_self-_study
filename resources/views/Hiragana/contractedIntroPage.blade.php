 ...
 <head>
  <title>Contracted Sound</title>
	...
	<div style="font-weight:bold; font-size: 50px; text-align: center;"><ruby><rb>拗音</rb><rt>ようおん</rt></ruby></div>
		...
		<p>　In contracted sounds such as “きゃ(Kya)”,  “きゅ(Kyu)”, and “きょ(Kyo)”, “き(Ki)” in “きゃ(Kya)”,  “きゅ(Kyu)”, and “きょ(Kyo)” is written in normal size, but the following “ゃ(ya)”, “ゅ(yu)”, and “ょ(yo)” are written in smaller size.</p>
	</div>
