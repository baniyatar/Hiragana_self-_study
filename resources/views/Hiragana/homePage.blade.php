...
<div class="box">
 <p style=" text-align:center;font-family:Century; font-size:35pt; font-weight:bold"> Click Letter You Want To Study</p>
     <table border ="1" style ="font-size:8vw; font-family: serif; border: 1px" >
         ...
         <tbody>
           <tr >
             <td ><a href="{{ url('/waAlphabet')}}"><div style="height:100%;width:100%">   わ</div> </a></td>
             <td ><a href="{{ url('/raAlphabet')}}"><div style="height:100%;width:100%">   ら</div> </a></td>
             <td ><a href="{{ url('/yaAlphabet')}}"><div style="height:100%;width:100%">   や</div> </a></td>
             　<td ><a href="{{ url('/maAlphabet')}}"><div style="height:100%;width:100%">   ま</div> </a></td>
           ...
           　<td ><a href="{{ url('/taAlphabet')}}"><div style="height:100%;width:100%">   た</div> </a></td>
             ...
             <td ><a href="{{ url('/kaAlphabet')}}"><div style="height:100%;width:100%">   か</div> </a></td>
             <td > <a href="{{ url('/aAlphabet')}}"><div style="height:100%;width:100%">   あ</div> </a></td>
           </tr>
           <tr >
             <td ></td>
             <td ><a href="{{ url('/riAlphabet')}}"><div style="height:100%;width:100%">   り</div> </a></td>
             <td ></td>
             　<td ><a href="{{ url('/miAlphabet')}}"><div style="height:100%;width:100%">   み</div> </a></td>
             <td ><a href="{{ url('/hiAlphabet')}}"><div style="height:100%;width:100%">   ひ</div> </a></td>
          ...
          　 <td ><a href="{{ url('/chiAlphabet')}}"><div style="height:100%;width:100%">   ち</div> </a></td>
           ...
           <tr >
             <td ></td>
             <td ><a href="{{ url('/ruAlphabet')}}"><div style="height:100%;width:100%">   る</div> </a></td>
             <td ><a href="{{ url('/yuAlphabet')}}"><div style="height:100%;width:100%">   ゆ</div> </a></td>
             　<td ><a href="{{ url('/muAlphabet')}}"><div style="height:100%;width:100%">   む</div> </a></td>
             <td ><a href="{{ url('/fuAlphabet')}}"><div style="height:100%;width:100%">   ふ</div> </a></td>
             ...
             <td ><a href="{{ url('/kuAlphabet')}}"><div style="height:100%;width:100%">   く</div> </a></td>
             <td ><a href="{{ url('/uAlphabet')}}"><div style="height:100%;width:100%">   う</div> </a></td>
           </tr>
           <tr >
             <td ></td>
             <td ><a href="{{ url('/reAlphabet')}}"><div style="height:100%;width:100%">   れ</div> </a></td>
             <td ></td>
             <td ><a href="{{ url('/meAlphabet')}}"><div style="height:100%;width:100%">   め</div> </a></td>
             <td ><a href="{{ url('/heAlphabet')}}"><div style="height:100%;width:100%">   へ</div> </a></td>
      ...
      　　　<td ><a href="{{ url('/teAlphabet')}}"><div style="height:100%;width:100%">   て</div> </a></td>
           ...
           <tr >
               <td ><a href="{{ url('/woAlphabet')}}"><div style="height:100%;width:100%">   を</div> </a></td>
               <td ><a href="{{ url('/roAlphabet')}}"><div style="height:100%;width:100%">   ろ</div> </a></td>
               <td ><a href="{{ url('/yoAlphabet')}}"><div style="height:100%;width:100%">   よ</div> </a></td>
               <td ><a href="{{ url('/moAlphabet')}}"><div style="height:100%;width:100%">   も</div> </a></td>
               <td ><a href="{{ url('/hoAlphabet')}}"><div style="height:100%;width:100%">   ほ</div> </a></td>
             ...
             <tr >
               <td ><a href="{{ url('/nAlphabet')}}"><div style="height:100%;width:100%">   ん</div> </a></td>
               <td ></td>
               <td ></td>
               <td ></td>
               <td ></td>
   ...
   <table border="1" style ="font-size: 7vw; font-family: serif;" >
     <tbody>
         <tr>  <td ><a href="{{ url('/ryaAlphabet')}}"><div style="height:100%;width:100%">りゃ</div> </a></td>
               ...
               <td ><a href="{{ url('/hyaAlphabet')}}"><div style="height:100%;width:100%">ひゃ</td>
                <td ><a href="{{ url('/chaAlphabet')}}"><div style="height:100%;width:100%">ちゃ</div> </a></td>
               <td ><a href="{{ url('/shaAlphabet')}}"><div style="height:100%;width:100%">しゃ</div> </a></td>
         ...
         <tr>
           ...
           <td ><a href="{{ url('/hyuAlphabet')}}"><div style="height:100%;width:100%">ひゅ</td>
            <td ><a href="{{ url('/chuAlphabet')}}"><div style="height:100%;width:100%">ちゅ</div> </a></td>
           <td ><a href="{{ url('/shuAlphabet')}}"><div style="height:100%;width:100%">しゅ</div> </a></td>
         ...
         <tr>
           ...
           <td ><a href="{{ url('/hyoAlphabet')}}"><div style="height:100%;width:100%">ひょ</td>
            <td ><a href="{{ url('/choAlphabet')}}"><div style="height:100%;width:100%">ちょ</div> </a></td>
           <td ><a href="{{ url('/shoAlphabet')}}"><div style="height:100%;width:100%">しょ</div> </a></td>
         ...
         <tr>
           <td ></td>
           <td ><a href="{{ url('/myaAlphabet')}}"><div style="height:100%;width:100%">みゃ</div> </a></td>
           <td ><a href="{{ url('/byaAlphabet')}}"><div style="height:100%;width:100%">びゃ</td>
           <td ><a href="{{ url('/nyaAlphabet')}}"><div style="height:100%;width:100%">にゃ</td>
           <td ><a href="{{ url('/jaAlphabet')}}"><div style="height:100%;width:100%">じゃ</div> </a></td>
         ...
         <tr>
           <td ></td>
           <td ><a href="{{ url('/myuAlphabet')}}"><div style="height:100%;width:100%">みゅ</div> </a></td>
           <td ><a href="{{ url('/byuAlphabet')}}"><div style="height:100%;width:100%">びゅ</td>
            <td ><a href="{{ url('/nyuAlphabet')}}"><div style="height:100%;width:100%">にゅ</td>
           <td ><a href="{{ url('/juAlphabet')}}"><div style="height:100%;width:100%">じゅ</div> </a></td>
           <td ><a href="{{ url('/gyuAlphabet')}}"><div style="height:100%;width:100%">ぎゅ</div></a></td>
          </tr>
   
          <tr>
           <td ></td>
           <td ><a href="{{ url('/myoAlphabet')}}"><div style="height:100%;width:100%">みょ</div> </a></td>
           <td ><a href="{{ url('/byoAlphabet')}}"><div style="height:100%;width:100%">びょ</td>
            <td ><a href="{{ url('/nyoAlphabet')}}"><div style="height:100%;width:100%">にょ</td>
           <td ><a href="{{ url('/joAlphabet')}}"><div style="height:100%;width:100%">じょ</div> </a></td>
