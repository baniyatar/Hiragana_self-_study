...
<html>
 <head>
  <title>のPAGE</title>
	...
	<img style="vertical-align:middle;" src="hiragana/no/sound-s.png" onclick="playSound0()">
</p>
    <div class = "letter_start">

  <img class = "testBorder" src="hiragana/no/no.gif" alt="のgif">
  <img src="hiragana/no/no.png" alt="のpng">
</div><br>  

<p class = "font_all_word">き<span style="color:red">の</span>う

  <audio id="audio1">
    <source src="hiragana/no/きのう.mp3" type="audio/mp3">
  </audio>
  <img style="vertical-align:middle;" src="hiragana/no/sound-s.png" onclick="playSound1()">

  <!-- <br><img src="hiragana/ta/red.png" alt=""> -->
</p>
<p class = "font_all_word">たても<span style="color:red">の</span>
  <audio id="audio2">
    <source src="hiragana/no/たてもの.mp3" type="audio/mp3">
  </audio>
  <img style="vertical-align:middle;" src="hiragana/no/sound-s.png" onclick="playSound2()">

  <!-- <br><img src="hiragana/ta/foot.png" alt=""> -->
</p>

<p class = "font_all_word">た<span style="color:red">の</span>しい
  <audio id="audio3">
    <source src="hiragana/no/たのしい.mp3" type="audio/mp3">
  </audio>
  <img style="vertical-align:middle;" src="hiragana/no/sound-s.png" onclick="playSound3()">

  <!-- <br><img src="hiragana/ta/head.png" alt=""> -->
</p>

<p class = "font_word"><span style="color:red">の</span>みも<span style="color:red">の</span>
  <audio id="audio4">
    <source src="hiragana/no/のみもの.mp3" type="audio/mp3">
  </audio>
  <img style="vertical-align:middle;" src="hiragana/no/sound-s.png" onclick="playSound4()">
