...
<html>
 <head>
  <title>にょPAGE</title>
    ...
    function playSoundnyou() { document.getElementById('audio1').play(); } 
    function playSoundnyoubau() { document.getElementById('audio2').play(); }
    function playSoundNyo() { document.getElementById('audioNyo').play(); }
  </script>
	<body>
	<div class="box">
